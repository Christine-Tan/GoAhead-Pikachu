...
//		System.out.println(institutiondata.add(po1).getMessage());
		...
		System.out
				.println(ins.getInsId() + ins.getInsCity() + ins.getInsName() + ins.getInsMember() + ins.getInsType());
		InstitutionPO po9 = new InstitutionPO("0011001", "南京市玄武区中转中心", "南京市", 65);
		...
		for (InstitutionPO get : institutiondata.findByCity("南京市")) {
			System.out.println(
					get.getInsId() + get.getInsCity() + get.getInsName() + get.getInsMember() + get.getInsType());
		}
