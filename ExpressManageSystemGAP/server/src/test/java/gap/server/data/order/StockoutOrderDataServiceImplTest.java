...
public class StockoutOrderDataServiceImplTest {
	...
	public void setUp() throws Exception {
		...
		gpo[0] = null;
		gpo[1] = new GoodsPO("0000000001", "A,A,1", SectorType.FLEX, "2015-11-25", "00000010", "00000011", "nanjing");
		gpo[2] = new GoodsPO("0000000002", "A,A,2", SectorType.CAR, "2015-11-25", "00000011", "00000011", "nanjing");
		gpo[3] = new GoodsPO("0000000003", "A,A,3", SectorType.TRAIN, "2015-11-25", "00000012", "00000012", "nanjing");
		gpo[4] = new GoodsPO("0000000004", "A,A,4", SectorType.PLANE, "2015-11-24", "00000013", "00000013", "nanjing");
		gpo[5] = new GoodsPO("0000000005", "A,A,5", SectorType.FLEX, "2015-11-24", "00000010", "00000011", "nanjing");
		gpo[6] = new GoodsPO("0000000006", "A,A,6", SectorType.CAR, "2015-11-24", "00000011", "00000011", "nanjing");
		gpo[7] = new GoodsPO("0000000007", "A,A,7", SectorType.TRAIN, "2015-11-23", "00000012", "00000012", "nanjing");
		gpo[8] = new GoodsPO("0000000008", "A,A,8", SectorType.PLANE, "2015-11-23", "00000013", "00000013", "nanjing");
		gpo[9] = new GoodsPO("0000000009", "A,A,9", SectorType.FLEX, "2015-11-23", "00000010", "00000021", "nanjing");
		gpo[10] = new GoodsPO("0000000010", "A,A,10", SectorType.CAR, "2015-11-23", "00000011", "00000021", "nanjing");
		gpo[11] = new GoodsPO("0000000011", "A,A,11", SectorType.TRAIN, "2015-11-22", "00000012", "00000022", "nanjing");
		gpo[12] = new GoodsPO("0000000012", "A,A,12", SectorType.PLANE, "2015-11-22", "00000013", "00000023", "nanjing");
		...
		or[0] = new StockoutOrderPO(list1, "2015-11-25", "0000008", "00000000000000000001", "CAR", "0000001");
		or[1] = new StockoutOrderPO(list2, "2015-11-26", "0000009", "00000000000000000002", "TRAIN", "0000001");
		or[2] = new StockoutOrderPO(list3, "2015-11-27", "0000010", "00000000000000000003", "PLANE","0000001");
		or[3] = new StockoutOrderPO(list4, "2015-11-28", "0000011", "00000000000000000004", "CAR", "0000002");
		or[4] = new StockoutOrderPO(list5, "2015-11-29", "0000012", "00000000000000000005", "TRAIN", "0000002");
		or[5] = new StockoutOrderPO(list6, "2015-11-30", "0000013", "00000000000000000006", "PLANE", "0000002");
	}
		...
		try {
			...
			if(!list.isEmpty()){
				for(StockoutOrderPO po :list){
					...
					System.out.println(po.getIns_id()+"     "+po.getOutDate()+"   "+po.getExpressorder_ids().size());
					System.out.println();
				}
			}
		} catch (RemoteException e) {
...
/*	@Test
	public void testUnPassed(){
		for(int i = 0;i<6;i++){
			try {
				stockout.setUnPassed(or[i].getId(), "lalala并没有什么用");
			} catch (RemoteException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
