...
public class StockinOrderDataServiceImplTest {
	...
	public void setUp() throws Exception {
		...
		gpo[9] = new GoodsPO("0000000009", "A,A,9", SectorType.FLEX, "2015-11-23", "00000010", "00000011", "nanjing");
	...
	public void testGetOneDay() {
		...
		try {
			List<StockinOrderPO> list = stockin.getOneDay("2015-11-22", "0000002");
			if(!list.isEmpty()){
				for(StockinOrderPO po :list){
					System.out.println(po.getId());
					System.out.println(po.getIns_id()+"     "+po.getInDate()+"   "+po.getGoods().size());
					System.out.println();
				}
			}
		} catch (RemoteException e) {
	...
	public void testGetRequired() {
		try {
			List<StockinOrderPO> list = stockin.getRequired("2015-11-21", "2015-11-25", "0000002");
