...
public class LoginAnimation extends JLabel{
	 ...
	 * @param downDivision
	 */
	private void makeShape(ArrayList<MovePoint> upPoints,ArrayList<MovePoint> downPoints,
			ArrayList<Integer> upDivision,ArrayList<Integer> downDivision){
...
//			}
			...
			double[] upBounds = {endColor.getRed(),endColor.getGreen(),endColor.getBlue()};
			double[] downBounds = {startColor.getRed(),startColor.getGreen(),startColor.getBlue()};
			...
			double rDiff = (endColor.getRed()-startColor.getRed()) * changeRate;
			double gDiff = (endColor.getGreen()-startColor.getGreen()) * changeRate;
			double bDiff = (endColor.getBlue()-startColor.getBlue())* changeRate;
