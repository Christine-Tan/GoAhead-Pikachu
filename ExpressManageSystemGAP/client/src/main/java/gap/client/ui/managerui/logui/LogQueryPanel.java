...
public class LogQueryPanel extends JPanel {
	...
	public LogQueryPanel() {
		...
		fromdate_jl.setText(logs.get(logs.size() - 1).getDate());
		todate_jl = new GAPTextField();
		todate_jl.setText(logs.get(0).getDate());
		...
		setLayout(gb);
		gcons.insets = new Insets(10, 200, 5, 0);
		SwingConsole.addComponent(gb, gcons, this, fromdate_jl, 0, 0, 1, 1, 0, 0);
		gcons.insets = new Insets(10, 5, 5, 0);
		SwingConsole.addComponent(gb, gcons, this, to_jl, 1, 0, 1, 1, 0, 0);
		gcons.insets = new Insets(10, 5, 5, 200);
		SwingConsole.addComponent(gb, gcons, this, todate_jl, 2, 0, 1, 1, 0, 0);
		gcons.insets=new Insets(5, 500, 5, 0);
		SwingConsole.addComponent(gb, gcons, this, total_jl, 0, 1, 1, 1, 0, 0);
		gcons.insets=new Insets(5, 5, 5, 0);
		SwingConsole.addComponent(gb, gcons, this, num_jl, 1, 1, 1, 1, 0, 0);
		gcons.insets=new Insets(5, 5, 5, 10);
		SwingConsole.addComponent(gb, gcons, this,result_jl, 2, 1, 1, 1, 0, 0);
	}
