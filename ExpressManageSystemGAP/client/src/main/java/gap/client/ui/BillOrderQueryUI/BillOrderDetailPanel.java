...
public class BillOrderDetailPanel extends JPanel {
	...
	private void reLayout() {
		...
		SwingConsole.addComponent(gb, gcons, this, courierid_jl, 0, 0, 1, 1, 1, 0);
		gcons.insets = new Insets(5, 0, 5, 0);
		SwingConsole.addComponent(gb, gcons, this, money_jl, 1, 0, 1, 1, 1, 0);
	...
	class ItemPanel extends JPanel {
		...
		ItemPanel(BillPO po) {
			...
			SwingConsole.addComponent(gbl, gcons, this, courierid, 0, 0, 1, 1, 1, 0);
			SwingConsole.addComponent(gbl, gcons, this, money, 1, 0, 1, 1, 1, 0);
		}
	}
}
