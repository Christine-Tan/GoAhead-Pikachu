...
public class Inventory implements InventoryService {
	...
	public ResultMessage exportExcel(String path) {
		...
		list0 = InventoryController.getOneTypeSector(ins_id + "0",
				ins_id);

		list1 = InventoryController.getOneTypeSector(ins_id + "1",
				ins_id);
		list2 = InventoryController.getOneTypeSector(ins_id + "2",
				ins_id);
		list3 = InventoryController.getOneTypeSector(ins_id + "3",
				ins_id);
