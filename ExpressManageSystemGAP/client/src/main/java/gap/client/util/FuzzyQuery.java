...
public class FuzzyQuery {
	 ...
	 * @return
	 */
	public static ArrayList<SearchResult> fuzzyQuery(String[] source,String keyword){
		return fuzzyQuery.query(source, keyword);
	}
	public static ArrayList<SearchResult> fuzzyQuery(ArrayList<String> source,String keyword){
